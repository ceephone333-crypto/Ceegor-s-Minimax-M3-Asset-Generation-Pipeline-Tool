// Block 22: extract buildParamRow + attachImageDimGuards
const fs = require('fs');
const path = 'renderer/app.js';
const targets = ['attachImageDimGuards', 'buildParamRow'];
...
const shim = '// Phase 3 Block 22: buildParamRow + attachImageDimGuards extrahiert\n// nach renderer/components/ParamRow.js.\nconst { helpButton, buildParamRow, attachImageDimGuards } = window.ParamRow;\n\n';
